      ...
      <div className="container px-6 py-12 mx-auto">
        <div className="lg:flex lg:items-center lg:-mx-6">
          <div className="lg:w-1/2 lg:mx-6">
            ...
            >
              Connect with us, drive <br /> change together
            </h1>
            <p className="mt-3 text-wrap">
              Reach out to learn more about our programs, or to <br /> share
              your ideas and support for our mission.
            </p>
            ...
            <div className="w-full px-8 py-10 mx-auto overflow-hidden bg-white rounded-lg shadow-2xl dark:bg-gray-900 lg:max-w-xl shadow-gray-300/50 dark:shadow-black/50">
              ...
              <form className="mt-6">
                ...
                <div className="w-full mt-6">
                  ...
                  <textarea
                    className="block w-full h-32 px-5 py-3 mt-2 text-gray-700
                     ...
                     md:h-32 dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 
                ...
                <button
                 ...
                 bg-[#E37423] rounded-md hover:bg-[#E37423] focus:outline-none focus:ring
                  focus:ring-[#E37423] focus:ring-opacity-50"
                >
                  Submit
                </button>
              </form>
