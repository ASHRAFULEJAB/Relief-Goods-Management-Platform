            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center justify-start">
                <button
                  ...
                  className="lg:hidden mr-2 text-white hover:text-gray-900 cursor-pointer p-2
              ...
              <div className="flex items-center">
                ...
                <Link
                  ...
                  className="hidden sm:inline-flex ml-5 text-white bg-cyan-600
                   hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium
                    rounded-lg text-sm px-5 py-2.5 text-center items-center mr-3"
