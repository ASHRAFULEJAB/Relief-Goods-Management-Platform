...
const AllReliefSectionCard = ({
  ...
  return (
    <div
      className="block rounded-lg shadow-secondary-2 bg-slate-100 
      bg-surface-dark flex flex-col justify-between h-full  transition-transform
    ...
    >
      <div>
        ...
        <div className="p-6 text-surface dark:text-white flex-grow">
...
export default AllReliefSectionCard;
